...
func tableBitbucketSnippetList(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
...
func tableBitbucketSnippetGet(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
...
type SnippetList struct {
	ListResponse
	Snippets []Snippet `json:"values,omitempty"`
}
